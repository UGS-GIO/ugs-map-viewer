...
import { isAutoGeneratedDefaultSymbolizer, buildGetLegendGraphicUrl } from '@/lib/legend/wms-legend-service';
...
const getWMSLayerRenderer = async (layer: __esri.WMSLayer) => {
    ...
    const legendUrl = buildGetLegendGraphicUrl(sublayer.name, layer.url);
