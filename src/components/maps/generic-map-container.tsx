...
import { PopupSheet, PopupSheetRef } from '@/components/custom/popups/popup-sheet'
...
import type { LayerContentProps } from '@/components/custom/popups/popup-content-with-pagination'
