    ...
    sublayers: [
        {
            ...
            popupFields: {
                ...
                // --- Fields below render in a table at the bottom of the popup ---
                'PH': { field: 'ph', type: 'string', table: true },
                'Conductivity (microsiemens)': { field: 'cond', type: 'string', table: true },
                'Sodium (mg/l)': { field: 'na', type: 'string', table: true },
                'Potassium (mg/l)': { field: 'k', type: 'string', table: true },
                'Calcium (mg/l)': { field: 'ca', type: 'string', table: true },
                'Magnesium (mg/l)': { field: 'mg', type: 'string', table: true },
                'Aluminum (mg/l)': { field: 'al', type: 'string', table: true },
                'Iron (mg/l)': { field: 'fe', type: 'string', table: true },
                'Silica (mg/l)': { field: 'sio2', type: 'string', table: true },
                'Boron (mg/l)': { field: 'b', type: 'string', table: true },
                'Lithium (mg/l)': { field: 'li', type: 'string', table: true },
                'Bicarbonate (mg/l)': { field: 'hco3', type: 'string', table: true },
                'Sulfate (mg/l)': { field: 'so4', type: 'string', table: true },
                'Chlorine (mg/l)': { field: 'cl', type: 'string', table: true },
                'fluorine (mg/l)': { field: 'f', type: 'string', table: true },
                'arsenic (mg/l)': { field: 'as', type: 'string', table: true },
                'TDS Measured (mg/l)': { field: 'tdsm', type: 'string', table: true },
                'TDS Calculated (mg/l)': { field: 'tdsc', type: 'string', table: true },
                'Cat/Anion Charge Balance': { field: 'chgbal', type: 'string', table: true },
            },
        },
    ],
};
