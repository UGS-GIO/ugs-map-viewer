...
const references = (
    <ul className="list-disc ml-5 space-y-4">
        ...
        <li>Blackett, R.E., and Wakefield, S., 2004, Geothermal resources of Utah: Utah Geological Survey Open File Report OFR-431dm, <a href="https://doi.org/10.34191/OFR-431dm">https://doi.org/10.34191/OFR-431dm</a>. </li>
        <li>Cagniard, L., 1953, Basic theory of the magneto-telluric method of geophysical prospecting: Geophysics, v. 18, p. 605–635. </li>
        <li>Christiansen A.V., Auken E., Sørensen K., 2006, The transient electromagnetic method, in Kirsch R., editor, Groundwater Geophysics: Springer, Berlin, Heidelberg, <a href="https://doi.org/10.1007/3-540-29387-6_6">https://doi.org/10.1007/3-540-29387-6_6</a>. </li>
        ...
        <li>Harmonica v0.7.0, 2024, Forward modeling, inversion, and processing gravity and magnetic data, <a href="https://zenodo.org/records/13308312">https://zenodo.org/records/13308312</a>. </li>
        ...
        <li>Wannamaker, P.E., Hohmann, G.W., and Ward, S.H., 1984, Magnetotelluric responses of three-dimensional bodies in layered earths: Geophysics, v. 49, no.9, p. 1517–1533, <a href="https://doi.org/10.1190/1.1441777">https://doi.org/10.1190/1.1441777</a>. </li>
...
const mapDetails = (
    <div className='mx-2 space-y-2'>
        ...
        <p>
            Explore the data by turning on layers and selecting features from the map to view details. To download data, see the Data Sources section or use the multi-select tool to download selected features. For questions or more information about geophysical data and geothermal resources, please contact Christian Hardwick at <a href="mailto:christianhardwick@utah.gov">christianhardwick@utah.gov</a>.
        </p>
    </div>
)
...
<p> 
    ...
    <ul>
        <li>Hazardous (Quaternary age) Faults - Utah Geological Survey <br />
            <a href="https://opendata.gis.utah.gov/datasets/utahDNR::utah-quaternary-faults/about">Access data</a>
        </li>
        <li>Great Basin Faults (INGENIOUS Project) - Geothermal Data Repository <br />
            <a href="https://gdr.openei.org/submissions/1391">Access data</a>
        </li>
        <li>Utah Faults - Utah Geological Survey <br />
            <a href="https://geology.utah.gov/publication-details/?pub%3DM-179dm">Access data</a>
        </li>
...
<p> 
    ...
    <ul>
        ...
        <li>Utah Roads - Local data stewards, UDOT, and UGRC <br />
            <a href="https://opendata.gis.utah.gov/datasets/utah-roads/about">Access data</a>
        </li>
        <li>Utah Railroads - UGRC <br />
            <a href="https://opendata.gis.utah.gov/datasets/utah-railroads/about">Access data</a>
        </li>
        <li>Transmission Lines - UGRC <br />
            <a href="https://opendata.gis.utah.gov/datasets/utah::utah-transmission-lines/about">Access data</a>
        </li>
        <li>Utah Land Ownership - School and Institutional Trust Lands Administration (SITLA), BLM, and Partners <br />
            <a href="https://opendata.gis.utah.gov/datasets/SITLA::land-ownership/about">Access data</a>
        </li>
    </ul>
    </p> 
</div>
