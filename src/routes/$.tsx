...
const NotFoundComponent = () => {
    return (
        // #root is overflow:clip (fixed viewport), so this route owns its scroller. min-h-full
        // (not h-full) on the centered flex lets a tall card scroll instead of being clipped by
        // align-items:center on a short viewport.
